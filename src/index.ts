...
// IPC handler to create a file from the main (Node) process
ipcMain.handle("create-h-file", async () => {
  try {
    createHFile();
    return { ok: true };
  } catch (err) {
    console.error("createHFile failed", err);
