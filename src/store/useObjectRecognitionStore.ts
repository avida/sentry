...
export const OBJECTS_POLL_INTERVAL_MS = 500;
...
export const useObjectRecognitionStore = create<ObjectRecognitionState>(
  (set, get) => ({
    objects: [],
    loading: false,
    error: null,
    ...
    intervalId: null,
    setObjects: (objects) =>
      set({ objects, lastUpdated: Date.now(), error: null }),
    fetchObjects: async () => {
